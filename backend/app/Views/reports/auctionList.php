...
<body>
  <div class="container mt-1" style="margin-top:-25px;">
    ...
    <div style="text-align:center;">
        <span style="font-size: 10pt; font-weight: bold;">( Auction List )</span><br/>
        <span style="font-size: 10pt; font-weight: bold;">Expired Items</span> <br/>
    </div>
        ...
        <tr style="border-bottom: 1px solid black;">
            <?php
                foreach ($columns as $key => $value) {
                    ...
                    if($value['name'] === "itemPawn"){
                        $cols .= '<td style="font-weight: bold; padding: 5px; text-align: left;">';
                    } else {
                        $cols .= '<td style="font-weight: bold; padding: 5px; text-align: center;">';
                    }
