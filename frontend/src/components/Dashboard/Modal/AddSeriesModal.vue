...
import registerForm from '../Forms/SeriesForm.vue';
...
export default {
    ...
    methods: {
        ...
        async saveOrData(){
            ...
            let payload = {
                seriesDate: this.userDetails.dateSelected,
                userId: Number(compoDetails.form.userId.value),
                start: compoDetails.form.start,
                end: compoDetails.form.end,
                reportStatus: Number(compoDetails.form.reportStatus.value),
                status: 1,
                createdBy: this.user.userId,
            }

            api.post('misc/set/user/reference', payload).then((response) => {
